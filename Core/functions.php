...
$url = "https://api.telegram.org/bot5731494604:AAGtUtx5f57kuNkBvqWgaVcDmKORAzn9HD4/editMessageText?chat_id=".$chatId."&message_id=".$message_id."&text=".$message."&parse_mode=HTML";
file_get_contents($url);      
}
